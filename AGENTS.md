...
This project is indexed by GitNexus as **Argus** (4963 symbols, 10916 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
