...
This project is indexed by GitNexus as **Argus** (5897 symbols, 13023 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
